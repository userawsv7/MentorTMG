...
export const FREE_PROVIDERS: ProviderSpec[] = [
  ...
  },
  {
    ...
    models: [
      { id: "llama-3.3-70b", label: "Llama 3.3 70B", purposes: ["reasoning", "general"], rank: 1, contextTokens: 128000 },
      { id: "llama3.1-8b", label: "Llama 3.1 8B", purposes: ["fast", "general"], rank: 2, contextTokens: 128000 },
      { id: "zai-glm-4.7", label: "ZAI GLM 4.7", purposes: ["coding", "general"], rank: 3, contextTokens: 128000 },
      { id: "gpt-oss-120b", label: "GPT-OSS 120B", purposes: ["reasoning", "coding", "general"], rank: 4, contextTokens: 128000 },
    ],
  },
  {
    key: "sambanova",
